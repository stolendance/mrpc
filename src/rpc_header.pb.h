...
PROTOBUF_NAMESPACE_OPEN
template<> ::src::RpcHeader* Arena::CreateMaybeMessage<::src::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace src {
...
class RpcHeader :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:src.RpcHeader) */ {
 public:
  RpcHeader();
  virtual ~RpcHeader();
  ...
  // @@protoc_insertion_point(class_scope:src.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:src.RpcHeader.service_name)
  return _internal_service_name();
}
inline void RpcHeader::set_service_name(const std::string& value) {
  _internal_set_service_name(value);
  // @@protoc_insertion_point(field_set:src.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  // @@protoc_insertion_point(field_mutable:src.RpcHeader.service_name)
...
inline void RpcHeader::set_service_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:src.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:src.RpcHeader.service_name)
}
inline void RpcHeader::set_service_name(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:src.RpcHeader.service_name)
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:src.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:src.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:src.RpcHeader.method_name)
  return _internal_method_name();
}
inline void RpcHeader::set_method_name(const std::string& value) {
  _internal_set_method_name(value);
  // @@protoc_insertion_point(field_set:src.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  // @@protoc_insertion_point(field_mutable:src.RpcHeader.method_name)
...
inline void RpcHeader::set_method_name(std::string&& value) {
  ...
  method_name_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:src.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:src.RpcHeader.method_name)
}
inline void RpcHeader::set_method_name(const char* value, size_t size) {
  ...
  method_name_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:src.RpcHeader.method_name)
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:src.RpcHeader.method_name)
...
inline void RpcHeader::set_allocated_method_name(std::string* method_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:src.RpcHeader.method_name)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RpcHeader::args_len() const {
  // @@protoc_insertion_point(field_get:src.RpcHeader.args_len)
...
inline void RpcHeader::set_args_len(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:src.RpcHeader.args_len)
}
