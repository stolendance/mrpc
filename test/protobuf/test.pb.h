...
class GetFriendListsResponse :
 ...
 public:
  ...
  private:
  const ::fixbug::User& _internal_friend_lists(int index) const;
  ::fixbug::User* _internal_add_friend_lists();
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > friend_lists_;
  ::fixbug::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
inline ::fixbug::User* GetFriendListsResponse::mutable_friend_lists(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.friend_lists)
...
GetFriendListsResponse::mutable_friend_lists() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.friend_lists)
  return &friend_lists_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_friend_lists(int index) const {
  return friend_lists_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::friend_lists(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.friend_lists)
  return _internal_friend_lists(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_friend_lists() {
  return friend_lists_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_friend_lists() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.friend_lists)
  return _internal_add_friend_lists();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListsResponse::friend_lists() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.friend_lists)
  return friend_lists_;
}
